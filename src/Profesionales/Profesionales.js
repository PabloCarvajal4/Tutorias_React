...
import TablaProfesionales from './TablaProfesionales'
import axios from 'axios'
class Profesionales extends React.Component{
    constructor(props){
        super(props);
        const listaProfesionales = [
            {
              ...
              edad: 36,
              descripcion: "Graduado de la Universidad Tecnologica Unitec,ejerce como docente en la misma Universidad"
            },
            {
              nombre: 'Rajel Gorgun',
              carrera: "Quimica y Farmacia con una maestria en Idiomas Foraneos",
              edad: 60,
              descripcion: "Graduada de la Universidad Autonoma de Honduras(Sede Tegucigalpa) y obtuvo la maestria en Estados Unidos,ejerce como docente en el Instituto San Juan Bautista"
              },
              {
              nombre: 'Reiniery Ayestas',
              carrera: "Ingeniero Quimico",
              edad: 56,
              descripcion: "Graduado de la Universidad Autonoma de Honduras(Sede Tegucigalpa),ejerce en la profesion como jefe de produccion de azucar"
              },
              {
              nombre: 'Jorge Carranza',
              carrera: "Arquitecto",
              edad: 39,
              descripcion: "Graduado de Ceutec con honores"
              },
              {
              nombre: 'Mateo Lopez',
              carrera: "Ingenierio Civil y Sistemas",
              edad: 40,
              descripcion: "Graduado de la Universidad Privada de San Pedro Sula"
              },
          ];
        this.state = {profesionales: listaProfesionales};
    }
    componentDidMount() {
      console.log("componentDidMount");
      axios.get('https://localhost:44323/api/profesionales')
      .then(Response =>{
        ...
        <Link  to="/Contacto">Contacto</Link> 
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/online-3412473.jpg" class="d-block w-100" alt="..." height="500px" />
                        </div>
                ...
                <h3>Perfil de Nuestros Profesionales</h3><br />
                <div className="container-sm">
                    <TablaProfesionales profesionales={this.state.profesionales} />
                </div>
                <br />
                <hr />
                <br />
