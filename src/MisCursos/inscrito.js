...
import TablaCursosInscritos from './TablaCursosInscritos';
import TablaTutoriasInscritas from './TablaTutoriasInscritas';
import TablaTutoriaPersonalizadas from './RegistroTutoriaPersonalizada';
import axios from 'axios';
  ...
  class Profesionales extends React.Component{
    constructor(props){
       ...
       /*   const listatutoriaspersonalizadas = [
            {
              id_tutoria: 1,
              usuario: "pablo04",
              nombre: "Pablo",
              ...
              fecha: "2021-07-06",
              hora: "7:30 pm",
              docente: "Jenny Guillen"
            },
          ];  
        this.state = {personalizada: listatutoriaspersonalizadas};*/
    }
   
    componentDidMount() {
      console.log("componentDidMount");
      axios.get('https://localhost:44323/api/cursoinscrito')
      .then(Response =>{
  ...
  /*componentDidMount() {
    console.log("componentDidMount");
    axios.get('https://localhost:44323/api/tutoriapersonalizada')
    .then(Response =>{
      console.log('response')
      this.setState({personalizada : Response.data})
    })
    .catch(error =>{
      console.log('error')
      console.log(error)
        ...
        <Link  to="/Contacto">Contacto</Link> 
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/workplace-3233497.jpg" class="d-block w-100" alt="..."  height="500px" />
                        </div>                 
                    </div>
                </div>
                </div>
                ...
                <h3>Cursos Registrados</h3><br />
                <div className="container-sm">
                    <TablaCursosInscritos cursos={this.state.cursos} />
                </div>
                <br/>
                <br />
                <hr />
