...
import TablaTutoriaPersonalizadas from './TablaTutoriasPersonalizadas';
import axios from 'axios';

  class PersonalizadasInscritas extends React.Component{
    constructor(props){
        super(props);
        const listapersonalizada = [
            ...
            },
            {
              id_tutoria: 2,
                usuario: "shadia",
                nombre: "Shadia",
                apellido: "Corra Nassar",
                clase: "Geometría y Trigonometría",
                fecha: "2021-07-14",
                hora: "7:00 am",
                docente: "Reiniery Ayestas"
              },
          ];
           this.state = {personalizada: listapersonalizada};        
    }
    ...
    render() {
      ...
      <Link  to="/Inicio">Inicio</Link>
        ...
        <Link  to="/Contacto">Contacto</Link> 
                ...
                <h3>Tutorías Personalizadas</h3><br />
                <div className="container-sm">
                    <TablaTutoriaPersonalizadas personalizada={this.state.personalizada} />
                </div>
                <br/>
                <br />
                <hr />
...
export default PersonalizadasInscritas;
