...
import axios from 'axios';
  ...
  class TutoriasInscritas extends React.Component{
    constructor(props){
        super(props);
        const listatutorias = [
            {
    ...
    componentDidMount() {
      ...
      axios.get('https://localhost:44323/api/tutoriainscrita')
      .then(Response =>{
    ...
    render() {
      ...
      <Link  to="/Inicio">Inicio</Link>
        ...
        <Link  to="/Contacto">Contacto</Link> 
                ...
                <h3>Tutorías Inscritas</h3><br />
                <div className="container-sm">
                    <TablaTutoriasInscritas tutorias={this.state.tutorias} />
                </div>
                <br/>
                <br />
                <hr />
...
export default TutoriasInscritas;
